...
The data set health.sas7bdat is a cross-sectional data set of patients discharged from a hospital in 2019. with the following columns: \* subject: observation identifier - PCP\_visit: had a PCP visit within 5 days of hospital discharge (1=had a visit, 0=did not have a visit) - SEX: (1=male; 0=female) - AGE: patient age in years - urban\_rural: live in an urban or non-urban (rural, or suburban) zipcode - unemp\_rate: unemployment rate in the subject's zip code - comorbidity\_score: general score of disease states - higher scores indicate higher illness burden - ALZ: had diagnosis of Alzheimer's (yes=1, no=0) - AST: had diagnosis of asthma (yes=1, no=0) - CAD: had diagnosis of coronary artery disease (yes=1, no=0) - CHF: had diagnosis of congestive heart failure (yes=1, no=0) - COPD: had diagnosis of chronic obstructive pulmonary disease (yes=1, no=0) - DIAB: had diagnosis of diabetes (yes=1, no=0) - HTN: had diagnosis of hypertension (yes=1, no=0) - OSTEO: had diagnosis of osteoarthritis (yes=1, no=0)
...
If you open up the code block, you will see the formula is similar to SAS.  The anova code call is slightly different, SAS defaults to using type 3 while R defaults to 1.  
